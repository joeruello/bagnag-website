    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
      <div class="bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-white overflow-hidden">
        <div class="my-3 py-3">
          ...
          <p>
            Bagnag ("us", "we", or "our") operates the Bagnag mobile application
            (the "Service").
          </p>
          ...
          <p>
            ...
            Personal Data, to Australia and process it there.
          </p>
          <p>
          ...
          <p>
            Bagnag will take all steps reasonably necessary to ensure that your
          ...
          <p>
            Bagnag may disclose your Personal Data in the good faith belief that
