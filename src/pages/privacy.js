...
const Privacy = () => (
  <Layout>
    ...
    <p>
      Bagnag ("us", "we", or "our") operates the Bagnag mobile application (the
      "Service").
    </p>
    ...
    <p>
      ...
      have associated with that data. Our Privacy Policy for Bagnag is managed
      through{' '}
    ...
    <p>Bagnag uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      If you are located outside Australia and choose to provide information to
      us, please note that we transfer the data, including Personal Data, to
      Australia and process it there.
    </p>
    <p>
    ...
    <p>
      Bagnag will take all steps reasonably necessary to ensure that your data
    ...
    <p>
      Bagnag may disclose your Personal Data in the good faith belief that such
      action is necessary to:
    </p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Bagnag</li>
      <li>
    ...
    <ul>
      <li>By email: joeruello@gmail.com</li>
    </ul>
  </Layout>
)
